...
import delimited "C:\Users\jkemper\OneDrive - Texas Tech University\Git\wreckem_model\Data\MasterTeamSpellings.csv", clear
...
import excel "C:\Users\jkemper\OneDrive - Texas Tech University\Git\wreckem_model\Data\NCAA_stats.xlsx", sheet("2021 - 2023") firstrow case(lower) clear
...
* Export predictions
export delimited using \\myweb.ttu.edu\users\jkemper\Assets\NCAA_predictions.csv, replace
...
local filepath `"C:\Users\jkemper\OneDrive - Texas Tech University\Git\wreckem_model\Data\Predictions\Predictions`fdate'.csv"'

* Display the filepath for verification
display "`filepath'"

* Export the dataset to the constructed file path
* Please ensure to replace the following placeholder command with your actual export command
* For example: 
