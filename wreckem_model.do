...
import delimited "C:\Users\James Kemper\OneDrive - Texas Tech University\Git\wreckem_bball\Data\MasterTeamSpellings.csv", clear
...
import excel "C:\Users\James Kemper\OneDrive - Texas Tech University\Git\wreckem_bball\Data\NCAA_stats.xlsx", sheet("2024") firstrow case(lower) clear
...
reg point_differential adj_off adj_def oppadj_off oppadj_def net prevnet avgoppnetrank avgoppnet netsos netnonconfsos wl confrecord nonconferencerecord roadwl quadrant1 quadrant2 quadrant3 quadrant4 oppnet oppprevnet oppavgoppnetrank oppavgoppnet oppnetsos oppnetnonconfsos oppwl oppconfrecord oppnonconferencerecord opproadwl oppquadrant1 oppquadrant2 oppquadrant3 oppquadrant4 if upcoming_game == 0
...
forvalues i = 1/`num_sims' {
    ...
    gen simulated_differential_`i' = point_differential + error_term_`i'
}
...
* Creat percentage winning team wins simulations 
gen percentage_sim_win = (teamwins / 500)
replace percentage_sim_win = (oppwins / 500) if oppwins > teamwins
format %9.2f percentage_sim_win


* Formate % win variable to two digits
format %9.2f percentage_sim_win
 
* Drop the intermediate simulation variables if they are no longer needed
forvalues i = 1/`num_sims' {
    drop error_term_`i' simulated_differential_`i'
...
* Gen predicted winning team variabls
...
keep date team teamid teamconf teamconfid oppteam oppteamid oppteamconf oppteamconfid predicted_winner upcoming_game threshold message percentage_sim_win
...
* Export predictions
export excel using "C:\Users\James Kemper\OneDrive - Texas Tech University\Git\wreckem_bball\Data\Wreckem_predictions.xlsx", sheet("predictions") sheetreplace firstrow(variables)
